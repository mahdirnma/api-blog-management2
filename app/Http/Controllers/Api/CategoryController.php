...
class CategoryController extends Controller
{
    ...
    public function store(StoreCategoryRequest $request)
    {
        ...
        $actionResult=$result->success?
            ...
            (new ApiResponseBuilder())->message('Category not created successfully');
    ...
    public function show(Category $category)
    {
        ...
        $actionResult=$result->success?
            ...
            (new ApiResponseBuilder())->message('Category not received successfully');
        return $actionResult->data($result->data)->response();
    }
    ...
    public function update(UpdateCategoryRequest $request, Category $category)
    {
        ...
        $actionResult=$result->success?
            ...
            (new ApiResponseBuilder())->message('Category not updated successfully');
        return $actionResult->data($result->data)->response();
    }
    ...
    public function destroy(Category $category)
    {
        ...
        $actionResult=$result->success?
            ...
            (new ApiResponseBuilder())->message('Category not deleted successfully');
